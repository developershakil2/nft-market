  ...
  return (
    <div className={Style.transfer}>
      <div className={Style.transfer_box}>
        <h1>Transfer BNB to your Family or Friends</h1>
        <p>
         YOu can send your BNB to any Wallet from here 
        </p>
        <div className={Style.transfer_box_box}>
          ...
          <div className={Style.transfer_box_box_right}>
            <h2>Now you can transfer BNB to any Wallet</h2>
        ...
        {/* //TRANSACTION HISTORY */}
        <h1 className={Style.transfer_box_h1}>TinyTesla Family</h1>
        <p>
    TinyTesla here for you, we are trustworthy from worldwide we are here for helping people stay connected with TinyTesla
        </p>
